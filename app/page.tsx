      ...
      <nav className="backdrop-blur-xl bg-black/30 border-b border-white/10 px-3 py-2.5 sticky top-0 z-50 shadow-2xl">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
          ...
          <div className="flex gap-1.5">
            ...
            <Link
              href="/telegram-setup"
              className="backdrop-blur-md bg-sky-500/20 hover:bg-sky-500/30 border border-sky-500/30 px-2.5 py-1.5 rounded-lg text-xs font-semibold transition flex items-center gap-1.5"
              title="Telegram Bot Setup"
            >
              <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12L7.065 13.4 4.19 12.52c-.644-.204-.657-.644.136-.953l11.057-4.262c.537-.194 1.006.131.51 1.916z"/>
              </svg>
